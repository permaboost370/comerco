...
export const metadata: Metadata = {
  ...
  description:
    "Ένας από τους μεγαλύτερους παραγωγούς φυσικών και βιολογικών λιπασμάτων στην Ευρώπη. Καινοτόμες λύσεις βιοτεχνολογίας για βιώσιμη γεωργία. 12+ χρόνια εμπειρίας στην Ελλάδα.",
  keywords: [
    "λιπάσματα",
    "βιολογικά λιπάσματα",
    "οργανικά λιπάσματα",
